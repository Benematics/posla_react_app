	...
	return(
		<>
			...
			<div class="container" style={{marginTop: "20px"}}>
	            ...
	            <div class="col-md-8">
	                ...
	                <div aria-label="breadcrumb" class="details-page-breadcrumb mb-10">
	                    <ol class="breadcrumb">
	                        <li class="breadcrumb-item"><a href="/category/deals/category1">Category</a></li>
	                        <li class="breadcrumb-item"><a href="/category/deals/category1">SubCategory</a></li>
	                ...
	                <div class="d-block d-md-none">
	                 ...
	                 <div class="section" id="about">
	                    ...
	                    <div class="line-height-20 bt-1-ddd pt-10">
	                        Hi, I am a deal manager working for a startup here in Ireland. I also help clients (individuals and businesses) to manage their online platforms (be it Web, Mobile, or Desktop Applications). I can manage deals both at development stage and maintenance stage.
	                    </div>
	                </div>
	                                    ...
	                                    <div class="user-img-text user-img-text-md bb-1-ddd proposal-list-each">
	                                        ...
	                                        <div class="overflow-hidden">
	                                            ...
	                                            <div class="mt-2">
	                                                ...
	                                                <button type="button" class="btn btn-orange btn-xs" data-toggle="modal" data-target="#view_proposal_2">Assign deal</button>
	                                                <button type="submit" class="btn btn-transparent-black btn-xs hover-bg-red" title="Remove shortlist" data-widget="collapse" data-toggle="tooltip">Shortlisted</button>
	                                            </div>
	                                        </div>
	                                    </div>
	        ...
	        <div class="font-18 font-bold pb-10 text-center b-none">
	            Other deals from this buyer
	        </div>
	        <div class="section">
	            <div class="deal-list deal-list-mini row">
	               {deal.map((item)=>(
	                    <div class="col-lg-6">
	                        <a href="/deal/c1d00230-a423-4b84-a121-7105239ff8d8" className="deal" id="deallist">
	                                <div>
	                                    <div>
